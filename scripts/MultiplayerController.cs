...
public partial class MultiplayerController : Control
{
	...
	public void _on_join_button_down()
	{
		...
		//peer.Host.Compress(ENetConnection.CompressionMode.RangeCoder);
		Multiplayer.MultiplayerPeer = peer;
		//GD.Print("Joining Game! " + Multiplayer.GetUniqueId().ToString());
	}
	...
	{
		var scene = ResourceLoader.Load<PackedScene>("res://scenes/main.tscn").Instantiate<Node3D>();
	...
	private void sendPlayerInformation(string name, int id)
	{
		...
		if (!GameManager.Players.Contains(playerInfo))
		{
			...
			//GD.Print("PlayerName: " + playerInfo.Name.ToString() + "---" + " PlayerID: " + playerInfo.Id);
		}
